...
function theme_register_menus() {
	register_nav_menus(array(
		'main_menu_header'				=> __('Main Menu - Header'),
		//'featured_menu_header'			=> __('Featured Menu - Header'),
		//'menu_footer_item_01'			=> __('Menu 01 - Footer'),
		'menu_footer_item_02'			=> __('Menu - Footer'),
		//'menu_footer_item_03'			=> __('Menu 03 - Footer'),
		'menu_footer_institutional'		=> __('Institutional Menu - Footer'),
	));
}
